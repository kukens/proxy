...
Proxy.prototype._onHttpServerRequest = function (isSSL, clientToProxyRequest, proxyToClientResponse) {
    ...
    function proxyToServerRequestComplete(serverToProxyResponse) {
        ...
        return self._onResponse(ctx, function (err) {
            ...
            if (ctx.serverToProxyResponse.headers['content-length'] && ctx.clientToProxyRequest.headers['proxyContentLength']) {
                ctx.serverToProxyResponse.headers['content-length'] = ctx.clientToProxyRequest.headers['proxyContentLength'];
            }
